...
function revealVoters()
{
	try {
		...
		NativeAPI.showMessageBox("Polus Stage Error", "An error occurred during revealVoters function:\n" + Std.string(e));
	}
}
...
function refreshVoters()
{
	try {
		...
		NativeAPI.showMessageBox("Polus Stage Error", "An error occurred during refreshVoters function:\n" + Std.string(e));
	}
}
...
function onBeatHit()
{
	try {
		...
		NativeAPI.showMessageBox("Polus Stage Error", "An error occurred during onBeatHit function:\n" + Std.string(e));
	}
}
...
function onSongStart()
{
	try {
		...
		NativeAPI.showMessageBox("Polus Stage Error", "An error occurred during onSongStart function:\n" + Std.string(e));
	}
}
	...
	try {
		switch (eventName)
		{
			...
			case 'meltdown':
				...
				NativeAPI.showMessageBox("Polus Stage Error", "An error occurred during onEvent function:\n" + Std.string(e));
	}
}
...
function buildMeltdownBG()
{
	try {
		...
		NativeAPI.showMessageBox("Polus Stage Error", "An error occurred during buildMeltdownBG function:\n" + Std.string(e));
	}
}
